...
<?php if(isset($_SESSION['user_id'])): ?>
    <?php 
    $is_following = is_following_category($_SESSION['user_id'], $category['categoryId']);
    $button_class = $is_following ? 'btn-danger' : 'btn-primary';
    $button_text = $is_following ? 'Unfollow' : 'Follow';
    ?>
    <button class="btn <?php echo $button_class; ?> follow-category" 
