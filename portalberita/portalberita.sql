...
(9, 'john@gmail.com', 'john', 'johnyy', '123');
...
(9, 'Email', 'email', 'john@gmail.com', 'mailto:john@gmail.com', 'konfigurasi');
...
ALTER TABLE `administrator` ADD `role` ENUM('admin', 'user', 'guest') NOT NULL DEFAULT 'user';
